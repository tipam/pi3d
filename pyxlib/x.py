...
ParentRelative = 1L	# background pixmap in CreateWindow
#				    and ChangeWindowAttributes 

CopyFromParent = 0L	# border pixmap in CreateWindow
#				       and ChangeWindowAttributes
#				   special VisualID and special window
#				       class passed to CreateWindow 

PointerWindow = 0L	# destination window in SendEvent 
InputFocus = 1L	# destination window in SendEvent 

PointerRoot = 1L	# focus window in SetInputFocus 

AnyPropertyType = 0L	# special Atom, passed to GetProperty 
