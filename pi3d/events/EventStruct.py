...
class EventStruct(object):
	...
	def encode(self):
		...
		return struct.pack(Format.Event, tsec, tfrac,  self.eventType, self.eventCode, self.eventValue)
	...
	def decode(self,s):
		...
		"""
		tsec, tfrac,  self.eventType, self.eventCode, self.eventValue = struct.unpack(Format.Event,s)
