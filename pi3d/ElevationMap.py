...
class ElevationMap(Shape):
  ...
  # determines how high an object is when dropped on the map (providing it's
  # inside the map area)
  def dropOn(self, x, z):
    wh = self.width * 0.5
    hh = self.depth * 0.5
  ...
  # accurately determines how high an object is when dropped on the map
